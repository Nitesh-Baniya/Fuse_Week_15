...
class ApplicationContainer:
    """Creates and manages all shared services used by the application.

    This container follows dependency injection principles to wire together
    all the services needed for the API to function. Services are created
    in a specific order to handle dependencies correctly.
    """

    def __init__(self, settings: Settings) -> None:
        self.settings = settings

        # Step 1: Create infrastructure clients (database, cache, external APIs)
        ...
        # Step 2: Build the RAG retrieval pipeline (embeddings + vector search)
        ...
        # Step 3: Build the AI agent with tool-calling capabilities
        ...
        # Step 4: Create business logic services for API endpoints
